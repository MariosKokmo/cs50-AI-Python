...
class MinesweeperAI():
    ...
    def find_neighbors(self,cell):
        ...
        i = cell[0]
        j = cell[1]
        if (i<self.height-1) and i>0:
            if (j<self.width-1) and j>0:
    ...
    def make_random_move(self):
        ...
        possible_cells = list(all_cells - self.mines - self.moves_made)

        # cells that are not known to be mines and that haven't already been chosen
